    ...
    <PromoComponent.StyledCard>
      ...
      >
        ...
        <PromoComponent.StyledButton onPress={onOpen}>
          <PromoComponent.ButtonText>Read more</PromoComponent.ButtonText>
...
const PromoPage = ({
  ...
  onClose: () => void;
  promoContentSrc: PromoContentType;
}) => {
  return (
    <View style={{ flex: 1 }}>
      <TouchableOpacity
      ...
      <ScrollView scrollEventThrottle={16}>
        <PromoComponent.ImageHeader source={promoContentSrc.promoImageFull} />
    ...
    <ParallaxScrollView>
      {selectedPromo ? (
        <PromoPage
          ...
          promoContentSrc={selectedPromo.promoContent}
        />
      ) : (
